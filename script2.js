...
function showMovies() {
  ...
  movies.forEach((movie)=> {
    ...
    movieContainer.classList.add("movie-container2");
    document.querySelector(".coverwrap2").append(movieContainer);

      var movieImage = document.createElement("img");
      movieImage.src = movie.fields.images[0].url;
      movieImage.classList.add("imgabout");
      document.querySelector(".coverwrap2").append(movieImage);
